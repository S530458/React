  ...
  handleClick(evt) {
    ...
    if (count === 2 && n[3] === '-' && n[7] === '-' && n.length === 12 && !pattern.test(n)
      ...
      if (Object.is(n.toLowerCase(), n.toUpperCase())) {
        window.alert(n + " is a Legal PhoneNumber")
      } else {
        window.alert(n + " is an illegal PhoneNumber")
      }
    } else {
      window.alert(n + " is an illegal PhoneNumber")
    }
  ...
  render() {
    ...
    return (
      ...
      <div className="App" >
        ...
        <form class="form-horizontal col-md-6" action="#">
          <fieldset>

            <legend>Check Phone Number</legend>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <button id="singlebutton" class="btn btn-success pull-left" name="verifyPhoneNumber" onClick={this.handleClick} >Check</button>
              </div>
            </div>
